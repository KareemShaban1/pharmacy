...
@section('content')
    <a href="#" class="btn btn-primary er fs-6 px-8 py-4 mb-5" data-bs-toggle="modal"
        data-bs-target="#kt_modal_new_product_group">{{ trans('backend.Add_product_group') }}</a>


    @include('backend.dashboard.views.productGroup.add_product_group_modal')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_edit_product_group{{ $group->id }}">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        @include('backend.dashboard.views.productGroup.edit_product_group_modal')

                                        <form action="{{ Route('productGroup.destroy', $group->id) }}" method="post"
