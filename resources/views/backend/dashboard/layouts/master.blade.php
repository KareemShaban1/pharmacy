...
<body id="kt_body" class="header-tablet-and-mobile-fixed aside-enabled">
    ...
    @include('backend.dashboard.layouts.explore_drawer')
    <!--end::Exolore drawer-->
    <!--end::Drawers-->
    <!--begin::Modals-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bolder w-100 mb-8">
                        <img alt="Logo" src="{{ asset('backend/media/svg/brand-logos/google-icon.svg') }}"
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                    <img src="{{ asset('backend/media/svg/card-logos/visa.svg') }}"
                                                        alt="" class="h-25px" />
                                                    <img src="{{ asset('backend/media/svg/card-logos/mastercard.svg') }}"
                                                        alt="" class="h-25px" />
                                                    <img src="{{ asset('backend/media/svg/card-logos/american-express.svg') }}"
                                                        alt="" class="h-25px" />
                                                </div>
                                                <!--end::Card logos-->
                                            </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100 text-center">
                                        ...
                                        <div class="text-center px-4 py-15">
                                            <img src="{{ asset('backend/media/illustrations/sketchy-1/9.png') }}"
